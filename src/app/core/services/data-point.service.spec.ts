...
describe('DataPointService', () => {
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            providers: [DataPointService, provideHttpClient(), provideHttpClientTesting()]
        });
...
 
    ...
    it('should fetch data points', () => {
        ...
        const req = httpMock.expectOne(`${environment.apiUrl}/datasources/1/datapoints?offset=0&limit=5`);
